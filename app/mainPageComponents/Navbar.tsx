                    ...
                    <div>
                        {userId ? (
                            <Link href={"/dashboard"}>
                                ...
                                className={`block rounded-lg px-9 py-3 font-medium text-white trasniiton`}
                                type="button"
                                >
                                Dashboard
                                </button>
                            ...
                            <div className="mt-4 flex flex-col gap-4 sm:mt-0 sm:flex-row sm:items-center">
                                <Link href={"/sign-in"}>
                                    <button
                                    style={backgroundColorObject}
                                    className={`block sm:w-32 w-full rounded-lg px-9 py-3 text-sm font-medium text-white transition focus:outline-none hover:bg-customRed border border-customRed`}
                                    type="button"
                                    >
                                    Sign In
                                    </button>
